...
export const DICT = {
  ko: {
    ...
    "header.syncSyncing": "동기화 중…",
    "header.syncSynced": "동기화됨",
    "header.syncError": "클라우드 연결 안 됨",
  ...
  en: {
    ...
    "header.syncSyncing": "Syncing…",
    "header.syncSynced": "Synced",
    "header.syncError": "Cloud disconnected",
